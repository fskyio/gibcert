...
- DNS-01 providers: manual, exec hook, RFC 2136/nsupdate, PowerDNS
...
- Exec DNS protocol extended for generic persistent record edits (TLSA, ECH, future DNS-managed material)
